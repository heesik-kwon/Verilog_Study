...
module digit_splitter #(
    parameter BIT_WIDTH = 7 // 100Hz 클럭 사용, 즉 0.01초마다 1씩 증가하는 tick 사용. 카운터가 100회 증가하면 1초가 되는 구조
) (
...
module bcd (
    input  [3:0] bcd, // 0~9까지 bcd 코드를 입력으로 받아서
    output [7:0] fnd_data // fnd_data에 output으로 뿌려줌
);
